        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                <a class="nav-link" href="{{route('masuk.landing')}}">Kembali ke Landing</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <h2 class="section-heading">Sistem Informasi Monitoring & Controlling Tambak Udang</h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="features" id="features">
        <div class="container">
            <div class="section-heading">
                <h2>Projek IoT Kerjasama!</h2>
                <hr>
                <h2> Bima Fajar Setiawan 21120115140088
                  <h2>Nur Kholid 211201151200XX</h2>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="list-inline">
                <li class="list-inline-item">
                    <a>Bima Fajar Setiawan 21120115140088</a>
                </li>
            </ul>
        </div>
    </footer>
