...
<body data-background-color="dark">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src=" {{ asset('Alantis/assets/img/mlane.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
							<li class="nav-item" >
									<a href="{{route('home.tamu')}}">
										<i class="fas fa-layer-group"></i>
										<p>Dashboard</p>
									</a>
								</li>	
						<li class="nav-item">
								<a href="{{route('report.tamu')}}">
	...
	<!--   Core JS Files   -->
	<script src="{{ asset('Alantis/assets/js/core/jquery.3.2.1.min.js') }}"></script>
	<script src="{{ asset('Alantis/assets/js/core/popper.min.js') }}"></script>
	<script src="{{ asset('Alantis/assets/js/core/bootstrap.min.js') }}"></script>

	<!-- jQuery UI -->
	<script src="{{ asset('Alantis/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js') }}"></script>
	<script src="{{ asset('Alantis/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js') }}"></script>

	<!-- jQuery Scrollbar -->
	<script src="{{ asset('Alantis/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js') }}"></script>


	<!-- Chart JS -->
	<script src="{{ asset('Alantis/assets/js/plugin/chart.js/chart.min.js') }}"></script>
	...
	<!-- Atlantis JS -->
	<script src="{{ asset('Alantis/assets/js/atlantis.min.js') }}"></script>

	<!-- Atlantis DEMO methods, don't include it in your project! -->
	<script src="{{ asset('Alantis/assets/js/setting-demo.js') }}"></script>
	<script src="{{ asset('Alantis/assets/js/demo.js') }}"></script>
	<script>
